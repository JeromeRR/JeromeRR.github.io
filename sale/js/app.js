...
!function (e) {
	...
	var o = !1,
	    ...
	    h = a.cancelAnimationFrame || a.webkitCancelAnimationFrame || a.mozCancelAnimationFrame || !1;if (u) a.cancelAnimationFrame || (h = function (e) {});else {
		var p = 0;u = function (e, o) {
		...
		if (v) return v;var e = l.createElement("DIV"),
			...
			i.transitionend = !1;for (var e = ["webkitTransition", "msTransition", "MozTransition", "OTransition", "OTransition", "KhtmlTransition"], t = ["-webkit-", "-ms-", "-moz-", "-o-", "-o", "-khtml-"], r = ["webkitTransitionEnd", "msTransitionEnd", "transitionend", "otransitionend", "oTransitionEnd", "KhtmlTransitionEnd"], s = 0, n = e.length; s < n; s++) if (e[s] in o) {
		...
		function v() {
			...
			if (!e) return !1;for (var t = e.target || e.srcElement || e || !1; t && t.id != o;) t = t.parentNode || !1;return !1 !== t;
			...
			var s = d[o] || !1;s || (s = { a: [], l: [], f: function (e) {
					for (var o = s.l, t = !1, r = o.length - 1; r >= 0; r--) if (!1 === (t = o[r].call(e.target, e))) return !1;return t;
				} }, T.bind(e, o, s.f, r, i), d[o] = s), T.ispage ? (s.a = [T.id].concat(s.a), s.l = [t].concat(s.l)) : (s.a.push(T.id), s.l.push(t));
		}, this.undelegate = function (e, o, t, r, i) {
			var s = d[o] || !1;if (s && s.l) for (var n = 0, l = s.l.length; n < l; n++) s.a[n] === T.id && (s.a.splice(n), s.l.splice(n), 0 === s.a.length && (T._unbind(e, o, s.l.f), d[o] = null));
			...
			T.stop(), T.cursortimeout && clearTimeout(T.cursortimeout);for (var e in T.delaylist) T.delaylist[e] && h(T.delaylist[e].h);T.doZoomOut(), T.unbindAll(), P.isie9 && T.win[0].detachEvent("onpropertychange", T.onAttributeChange), !1 !== T.observer && T.observer.disconnect(), !1 !== T.observerremover && T.observerremover.disconnect(), !1 !== T.observerbody && T.observerbody.disconnect(), T.events = null, T.cursor && T.cursor.remove(), T.cursorh && T.cursorh.remove(), T.rail && T.rail.remove(), T.railh && T.railh.remove(), T.zoom && T.zoom.remove();for (var o = 0; o < T.saved.css.length; o++) {
				...
				if (this && this.id === T.id) {
					delete r[e];for (var o = ++e; o < r.length; o++, e++) r[e] = r[o];--r.length && delete r[r.length];
				}
			});for (var i in T) T[i] = null, delete T[i];T = null;
			...
			if (T.ishwscroll && P.hastransition && M.usetransition && M.smoothscroll) {
				...
				var r = T.getScrollTop(),
				    ...
				    l = T.getTransitionSpeed(n);T.bzscroll = {};var a = s ? 1 : .58;T.bzscroll.x = new R(i, T.newscrollx, l, 0, 0, a, 1), T.bzscroll.y = new R(r, T.newscrolly, l, 0, 0, a, 1);f();var c = function () {
					if (T.scrollrunning) {
	    ...
	    x = e.fn.scrollTop;e.cssHooks.pageYOffset = { get: function (e, o, t) {
	...
	};var S = e.fn.scrollLeft;n.cssHooks.pageXOffset = { get: function (e, o, t) {
		...
		void 0 !== o || "object" != typeof e || "jquery" in e || (o = e, e = !1);var t = new z();return this.each(function () {
			var r = n(this),
			    i = n.extend({}, o);if (e) {
...
// mocRate = 132123,
// today = new Date(),
// firstWeek = new Date(2018, 2, 21),
// secondWeek = new Date(2018, 2, 28),
// thirdWeek = new Date(2018, 3, 4),
// fourthWeek = new Date(2018, 3, 11),
// endBenefit = new Date(2018, 3, 17),
// result = 1;
// (function calculator(x) {

// 	if ((today > firstWeek) && (today < secondWeek) )  {
// 		result = x * mocRate * 1.15;
// 	} else if ((today > secondWeek) && (today < thirdWeek)) {
// 		result = x * mocRate * 1.1;
// 	} else if ((today > thirdWeek) && (today < fourthWeek)) {
// 		result = x * mocRate * 1.05;
// 	} else if ((today > fourthWeek) && (today < endBenefit)) {
// 		result = x * mocRate * 1.025;
// 	} else {
// 		return result = x * mocRate ;
// 	};
	
// 	if (isNaN(result)){
// 		document.getElementById("output__value").innerHTML = "not a number";
// 	} else{
// 		document.getElementById("output__value").innerHTML = result;
// 	};
