...
!function t(e, n, r) {
  function o(i, s) {
  ...
  }for (var l = "function" == typeof require && require, i = 0; i < r.length; i++) o(r[i]);return o;
}({ 1: [function (t, e, n) {
    "use strict";
    function r(t) {
    ...
    var r = t("./class"),
      ...
      if (t) {
        if (t.constructor === Array) return t.map(i);if ("object" == typeof t) {
          var e = {};for (var n in t) e[n] = i(t[n]);return e;
        }return t;
      }return null;
    };n.extend = function (t, e) {
      var n = i(t);for (var r in e) n[r] = i(e[r]);return n;
        ...
        if (!(c.isDefaultPrevented && c.isDefaultPrevented() || c.defaultPrevented)) {
          var u = l.matches(e.scrollbarX, ":focus") || l.matches(e.scrollbarY, ":focus");if (r || u) {
            var d = document.activeElement ? document.activeElement : e.ownerDocument.activeElement;if (d) {
              if ("IFRAME" === d.tagName) d = d.contentDocument.activeElement;else for (; d.shadowRoot;) d = d.shadowRoot.activeElement;if (o.isEditable(d)) return;
            }var p = 0,
    ...
    var r = t("../lib/helper"),
      ...
      e = "object" == typeof e ? e : {}, o.add(t, "ps-container");var n = l.add(t);n.settings = r.extend(n.settings, e), o.add(t, "ps-theme-" + n.settings.theme), n.settings.handlers.forEach(function (e) {
        s[e](t);
      }), a(t), i(t);
    };
